...
[DEF] = KEYMAP( \
  ...
  KC_LCTL,KC_LGUI,KC_LALT,                        SPACEFN,                        KC_RALT,KC_LALT,MO(FUN),KC_RCTL,  KC_LEFT,KC_DOWN,KC_RGHT),
...
/* Layer 2: Space-FN layer */ //TODO: 1) improve layer, 2) add keymap overview, 3) update readme.md
[SFN] = KEYMAP( \
  _______,        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,  _______,_______,_______, \
  _______,_______,_______,_______,_______,_______,KC_NLCK,KC_P7,  KC_P8,  KC_P9,  KC_PSLS,_______,_______,_______,  _______,_______,_______, \
  _______,_______,_______,_______,_______,_______,_______,KC_P4,  KC_P5,  KC_P6,  KC_PAST,_______,_______,_______,  _______,_______,_______, \
  KC_SPC, _______,_______,_______,_______,_______,_______,KC_P1,  KC_P2,  KC_P3,  KC_PMNS,_______,/*NUHS*/KC_SPC,                            \
  _______,_______,_______,_______,_______,_______,_______,_______,KC_P0,  _______,KC_PDOT,KC_PPLS,        _______,          _______,         \
